    ...
    <section id="contact">
        ...
        <form id="form_contact" name="form_contact" action="http://gil83.fr/nolark/testforms.php" method="POST">
            <fieldset id="coordo">
                ...
                <div><label for="i_prenom">Votre prénom :</label> <input type="text" name="i_prenom" id="i_prenom" size="35" pattern="^[a-zA-Z�����������������������������������������������������ݟƌ\s\-]+$" required>
                    <div class="input-validation"></div>
                </div>
                ...
                <fieldset id="marques">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type="checkbox" name="chk_marques[]" id="chk_arai" value="arai"><label for="chk_arai">arai</label></td>
                        </tr>
                        <tr>
